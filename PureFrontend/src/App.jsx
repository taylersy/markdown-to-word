...
`);
  ...
  const handleExport = async () => {
    ...
    try {
      // Initialize Pandoc with files from public directory
      const pandoc = new Pandoc({
        url: 'pandoc-wasm.wasm.gz',
        dataUrl: 'pandoc-data.data.gz'
      });
      
      await pandoc.init();

      // Convert Markdown to Docx
      // Pandoc natively supports creating .docx with OMML math from markdown+tex_math_dollars
      ...
      // Create Blob from result (Uint8Array)
